...
// lib/opal/lexer.rb
(function() {
  var __opal = Opal, self = __opal.top, __scope = __opal, nil = __opal.nil, __breaker = __opal.breaker, __slice = __opal.slice, __klass = __opal.klass, __module = __opal.module, __range = __opal.range, __hash2 = __opal.hash2;
  ...
  return (function(__base){
    ...
    (function(__base, __super){
      // line 11, opal/lexer, class Grammar
      function Grammar() {};
      Grammar = __klass(__base, __super, "Grammar", Grammar);
      ...
      (function(__base, __super){
        // line 45, opal/lexer, class LexerScope
        function LexerScope() {};
...
// lib/opal/parser.rb
(function() {
  var __opal = Opal, self = __opal.top, __scope = __opal, nil = __opal.nil, __breaker = __opal.breaker, __slice = __opal.slice, __module = __opal.module, __klass = __opal.klass, __hash2 = __opal.hash2, __range = __opal.range;
  ...
  return (function(__base){
    ...
    Opal.$runtime = function() {
      ...
      corelib = (__b = __scope.File.$read(load_order).$strip().$split(), __b.$map._p = (__a = function(c) {
        ...
        return __scope.Opal.$parse(source, file);
      }, __a._s = this, __a), __b.$map());
    ...
    Opal.$parser_code = function() {
      ...
      return [__scope.Builder.$new(__hash2(["files", "dir"], {"files": ["racc.rb", "strscan.rb"], "dir": __scope.File.$join(this.$core_dir(), "parser")})).$build(), this.$build_gem("opal"), __scope.File.$read(__scope.File.$join(this.$core_dir(), "parser", "browser.js"))].$join("\n")
    };
  ...
  return (function(__base){
    ...
    (function(__base, __super){
      ...
      RakeTask_prototype.$build_gem = function(name) {
        ...
        this.$puts(" * " + (out));
        return this.$write_code(__scope.Opal.$build_gem(name), out);
        } catch ($err) {
      ...
      RakeTask_prototype.$define_tasks = function() {
        ...
        return this.$task(__hash2(["opal"], {"opal": ["opal:build", "opal:dependencies", "opal:spec"]}));
      };
