    ...
    (function($base) {
      ...
      def.$alias_native = function(new$, old, options) {
        ...
        if (($a = old['$end_with?']("=")) !== false && $a !== nil) {
          return ($a = ($b = self).$define_method, $a._p = (TMP_4 = function(value) {var self = TMP_4._s || this;
...
if (value == null) value = nil;
          ...
          return ($a = ($c = self).$define_method, $a._p = (TMP_5 = function(args) {var self = TMP_5._s || this, block, $a, $b, $c;
            if (self['native'] == null) self['native'] = nil;
args = $slice.call(arguments, 0);
          ...
          return ($a = ($d = self).$define_method, $a._p = (TMP_6 = function(args) {var self = TMP_6._s || this, block, $a, $b;
            if (self['native'] == null) self['native'] = nil;
args = $slice.call(arguments, 0);
            block = TMP_6._p || nil, TMP_6._p = null;
            return ($a = ($b = $scope.Native).$call, $a._p = block.$to_proc(), $a).apply($b, [self['native'], old].concat(args))}, TMP_6._s = self, TMP_6), $a).call($d, new$)
        };
      }
