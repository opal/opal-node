...
(function($opal) {
  ...
  return (function($base) {
    ...
    def.$lazy = function() {
      ...
      return ($a = ($b = ($scope.Enumerator)._scope.Lazy).$new, $a._p = (TMP_16 = function(enum$, args) {var self = TMP_16._s || this, $a;if (enum$ == null) enum$ = nil;args = $slice.call(arguments, 1);
    ...
    def.$slice_before = TMP_23 = function(pattern) {
      var $a, $b, TMP_24, self = this, $iter = TMP_23._p, block = $iter || nil;
      TMP_23._p = null;
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      def.$grep = TMP_23 = function(pattern) {
        ...
        TMP_23._p = null;
        if (block !== false && block !== nil) {
          return ($a = ($b = $scope.Lazy).$new, $a._p = (TMP_24 = function(enum$, args) {var self = TMP_24._s || this;if (enum$ == null) enum$ = nil;args = $slice.call(arguments, 1);
          ...
          return ($a = ($c = $scope.Lazy).$new, $a._p = (TMP_25 = function(enum$, args) {var self = TMP_25._s || this;if (enum$ == null) enum$ = nil;args = $slice.call(arguments, 1);
...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$new', '$class', '$raise', '$===', '$to_a', '$respond_to?', '$to_ary', '$coerce_to', '$==', '$to_str', '$clone', '$hash', '$<=>', '$fits_fixnum!', '$empty?', '$enum_for', '$nil?', '$coerce_to!', '$initialize_clone', '$initialize_dup', '$replace', '$eql?', '$length', '$begin', '$inspect', '$end', '$exclude_end?', '$fits_array!', '$flatten', '$object_id', '$[]', '$to_s', '$delete_if', '$to_proc', '$each', '$reverse', '$map', '$rand', '$keep_if', '$shuffle!', '$>', '$<', '$sort', '$times', '$[]=', '$<<', '$at']);
  return (function($base, $super) {
    function Array(){};
